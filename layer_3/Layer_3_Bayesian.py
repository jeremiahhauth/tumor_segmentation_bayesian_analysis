...
with mirrored_strategy.scope():
    ...
    encoder_1_b = keras.layers.Conv2D(FILTERS*2, name='encoder_1_b', **params)(encoder_1_a)
    downsample_1 = keras.layers.MaxPool2D(name='downsample_1')(encoder_1_b)

    encoder_2_a = tfp.layers.Convolution2DFlipout(FILTERS, name='encoder_2_a', **flipout_params)(downsample_1)
...
# bias_prior = model.layers[3].bias_prior
# bias_posterior = model.layers[3].bias_posterior
# kernel_prior = model.layers[3].kernel_prior
# kernel_posterior = model.layers[3].kernel_posterior
